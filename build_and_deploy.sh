...
access_keys=( $bamboo_SIT_ACCESS_KEY $bamboo_UAT_ACCESS_KEY $bamboo_PROD_ACCESS_KEY)
secret_keys=( $bamboo_SIT_SECRET_KEY $bamboo_UAT_SECRET_KEY $bamboo_PROD_SECRET_KEY)
